...
<head>
  ...
  <title>Admin - Search Suspects</title>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td><?= $i ?></td>
                <td><?= htmlspecialchars($suspect['suspect_id']) ?></td>
                <td>
                  <a href="suspect_view.php?suspect_id=<?= htmlspecialchars($suspect['suspect_id']) ?>">
                    <?= htmlspecialchars($suspect['fname']) ?>
                  </a>
                </td>
                <td><?= htmlspecialchars($suspect['lname']) ?></td>
                <td><?= htmlspecialchars($suspect['username']) ?></td>
                <td>
                  <a href="suspect_edit.php?suspect_id=<?= htmlspecialchars($suspect['suspect_id']) ?>"
                     class="btn btn-warning btn-sm">Edit</a>
                  <a href="suspect_delete.php?suspect_id=<?= htmlspecialchars($suspect['suspect_id']) ?>"

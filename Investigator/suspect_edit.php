...
if (
    ...
    $case = getCaseBySuspectId($suspect_id, $conn); // New
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 mt-3">
      ...
      <div class="col-md-10 p-4">
        ...
        <form method="post" class="shadow p-4 mt-5 bg-white" action="req/suspect-change.php" id="change_password">
          ...
          <div class="mb-3">
              <label class="form-label">Investigator Password</label>
              <input type="password" name="investigator_pass" class="form-control">
          </div>
